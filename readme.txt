=== Ubernet SMS ===
Contributors: Moshiur Rahman
Stable tag: trunk
Tags: sms, woocommerce, uernet, notify, bangladesh, ubernet sms
...
We do not provide support or we are not liable for SMS service. We just provide the SMS sending tool.
== Installation ==
...
= Is this plugin provide sms service? =

No, this plugin only helps to connect sms service providers API to send sms.
